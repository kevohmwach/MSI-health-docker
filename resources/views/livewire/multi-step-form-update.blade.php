                    ...
                    <div class="personal_info">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <select <?php if(Auth::user()->role<2){echo 'disabled';} ?> class="dropdown" name="county" id="county"  wire:model="county">
                ...
                <div class="step-two">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <select <?php if(Auth::user()->role<2){echo 'disabled';} ?> class="dropdown" name="physician_id_1" id="physician_id_1"  wire:model="physician_id_1">
                                <option value="">Select</option>
                        ...
                        <div>
                            ...
                            <select <?php if(Auth::user()->role<2){echo 'disabled';} ?> class="dropdown" name="physician_id_2" id="physician_id_2"  wire:model="physician_id_2">
                                <option value="">Select</option>
                                    @foreach ($practitioner_data as $practitioner_)
                                        <option value="{{$practitioner_->id}}">{{$practitioner_->pract_name}}</option>
                                    @endforeach
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <select <?php if(Auth::user()->role<2){echo 'disabled';} ?> class="dropdown" name="pharmacist_id_1" id="pharmacist_id_1"  wire:model="pharmacist_id_1">
                                <option value="">Select</option>
                                    @foreach ($practitioner_data as $practitioner_)
                                        <option value="{{$practitioner_->id}}">{{$practitioner_->pract_name}}</option>
                                    @endforeach
                        ...
                        <div>
                            ...
                            <select <?php if(Auth::user()->role<2){echo 'disabled';} ?> class="dropdown" name="pharmacist_id_2" id="pharmacist_id_2"  wire:model="pharmacist_id_2">
                                <option value="">Select</option>
                                    @foreach ($practitioner_data as $practitioner_)
                                        <option value="{{$practitioner_->id}}">{{$practitioner_->pract_name}}</option>
                                    @endforeach
                    ...
                    <div class="step-two">
                        ...
                        <div class="row_entry dose_n_sig">
                            ...
                            <div>
                                ...
                                <select <?php if(Auth::user()->role<2){echo 'disabled';} ?> class="dropdown" name="dose_n_sig_1_units" id="dose_n_sig_1_units"  wire:model="dose_n_sig_1_units">
                                    <option value="">Select</option>
                            ...
                            <div>
                                ...
                                <select <?php if(Auth::user()->role<2){echo 'disabled';} ?> class="dropdown" name="dose_n_sig_1_administration" id="dose_n_sig_1_administration"  wire:model="dose_n_sig_1_administration">
                                    <option value="">Select</option>
                        ...
                        <div class="row_entry dose_n_sig">
                            ...
                            <div>
                                ...
                                <select <?php if(Auth::user()->role<2){echo 'disabled';} ?> class="dropdown" name="dose_n_sig_2_units" id="dose_n_sig_2_units"  wire:model="dose_n_sig_2_units">
                                    <option value="">Select</option>
                                    <option value="Mcg">Mcg</option>
                                    <option value="Mg">Mg</option>
                                    <option value="G">G</option>
                            ...
                            <div>
                                ...
                                <select <?php if(Auth::user()->role<2){echo 'disabled';} ?> class="dropdown" name="dose_n_sig_2_administration" id="dose_n_sig_2_administration"  wire:model="dose_n_sig_2_administration">
                                    <option value="">Select</option>
                                    <option value="Oral">Oral</option>
                                    <option value="Injection">Injection</option>
                                </select>
                        ...
                        <div class="row_entry dose_n_sig">
                            ...
                            <div>
                                ...
                                <select <?php if(Auth::user()->role<2){echo 'disabled';} ?> class="dropdown" name="dose_n_sig_3_units" id="dose_n_sig_3_units"  wire:model="dose_n_sig_3_units">
                                    <option value="">Select</option>
                                    <option value="Mcg">Mcg</option>
                                    <option value="Mg">Mg</option>
                                    <option value="G">G</option>
                            ...
                            <div>
                                ...
                                <select <?php if(Auth::user()->role<2){echo 'disabled';} ?> class="dropdown" name="dose_n_sig_3_administration" id="dose_n_sig_3_administration"  wire:model="dose_n_sig_3_administration">
                                    <option value="">Select</option>
                                    <option value="Oral">Oral</option>
                                    <option value="Injection">Injection</option>
                                </select>
                        ...
                        <div class="row_entry dose_n_sig">
                            ...
                            <div>
                                ...
                                <select <?php if(Auth::user()->role<2){echo 'disabled';} ?> class="dropdown" name="dose_n_sig_4_units" id="dose_n_sig_4_units"  wire:model="dose_n_sig_4_units">
                                    <option value="">Select</option>
                                    <option value="Mcg">Mcg</option>
                                    <option value="Mg">Mg</option>
                                    <option value="G">G</option>
                            ...
                            <div>
                                ...
                                <select <?php if(Auth::user()->role<2){echo 'disabled';} ?> class="dropdown" name="dose_n_sig_4_administration" id="dose_n_sig_4_administration"  wire:model="dose_n_sig_4_administration">
                                    <option value="">Select</option>
                                    <option value="Oral">Oral</option>
                                    <option value="Injection">Injection</option>
                                </select>
