                ...
                <div class="step-two">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            {{-- <input <?php if(Auth::user()->role<2){echo 'disabled';} ?> type="radio" id="surgery_yes" name="surgery" value="Yes"  wire:model="surgery">
                            <label for="surgery_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input <?php if(Auth::user()->role<2){echo 'disabled';} ?> type="radio" id="surgery_no" name="surgery" value="No"  wire:model="surgery">
